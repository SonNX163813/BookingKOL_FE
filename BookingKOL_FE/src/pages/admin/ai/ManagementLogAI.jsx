...
const ManagementLogAI = () => {
  ...
  // ✅ chỉ lọc theo ngày tạo => dùng 1 RangePicker (start/end)
  ...
  const handleSearch = (value) => {
    ...
    const [start, end] = value.createdRange || [];
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        key: "answer",
        dataIndex: "answer",
        render: (answer) => <div className="line-clamp-2">{answer}</div>,
        width: "33%",
      },
      {
        title: "Ngày tạo",
      ...
      <div className="relative h-full">
        ...
        <div className="flex gap-3 py-3">
          <Form form={form} className="flex gap-3" onFinish={handleSearch}>
            ...
            {/* ✅ Date picker tiếng Việt + chỉ lọc theo ngày tạo + kéo dài ô ngày */}
            <Form.Item name="createdRange">
              <RangePicker
                className="!h-12 min-w-[380px]"
                format="DD/MM/YYYY"
