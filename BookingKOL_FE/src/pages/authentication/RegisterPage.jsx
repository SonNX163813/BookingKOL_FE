...
export default function RegisterPage() {
  ...
  // ✅ đạt chuẩn mạnh theo regex => ẩn popup hints
  const isPwdStrong = useMemo(() => strong.test(password), [password]);
  ...
  // ================== LIMIT MAX_PWD + SHOW MESSAGE + BLOCK INPUT ==================
        ...
        <form className="form" onSubmit={handleSubmit} noValidate>
          ...
          <div style={{ position: "relative", width: "100%" }}>
            <input
              ...
              aria-describedby={
                showHints && !isPwdStrong ? "pwd-hints" : undefined
              }
            />
            <button
              type="button"
            ...
            {/* POPUP gợi ý: chỉ hiện khi focus + CHƯA đủ mạnh */}
            {showHints && !isPwdStrong && (
              <div
                id="pwd-hints"
                role="alert"
                style={{
          ...
          {/* ✅ TERMS: đưa xuống cuối form giống Login */}
          <div className="terms">
            <label>
              <input
                type="checkbox"
